...
### 🚀 Start Here
- **[QUICK_START_DOCS.md](_media/QUICK_START_DOCS.md)** - ⚡ 5-minute quick start guide
- **[DEVELOPER_REFERENCE.md](_media/DEVELOPER_REFERENCE.md)** - 🚨 **Debugging & File Map** ⭐ NEW!

### 📖 Core Documentation
1. **[SCAN_FLOW.md](_media/SCAN_FLOW.md)** - 📋 Complete scan flow (end-to-end, 2,087 lines)
2. **[DEVELOPER_REFERENCE.md](_media/DEVELOPER_REFERENCE.md)** - 🛠️ File-by-file developer guide with regex patterns
...
- **[../DOCUMENTATION.md](_media/DOCUMENTATION.md)** - Master documentation guide
- **[../DOCUMENTATION_CHEATSHEET.md](_media/DOCUMENTATION_CHEATSHEET.md)** - Quick reference
...
2. Follow [SCAN_FLOW.md](_media/SCAN_FLOW.md) to understand the complete flow
...
Focus on:
1. [SCAN_FLOW.md](_media/SCAN_FLOW.md) - User flow
