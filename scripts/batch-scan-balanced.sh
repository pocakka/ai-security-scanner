...
# BALANCED MODE - Közepes sebesség, otthoni nethez optimalizált
# 20 domain batchenként, kis késleltetéssel az API hívások között
...
SCAN_FILE="/tmp/balanced-1000-scan-ids.txt"
